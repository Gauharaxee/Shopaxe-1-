      ...
      >
        <div className="flex items-center justify-between pb-3 border-b border-neutral-800">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-serif text-lg font-bold text-white">Add Customer Record</h3>
              <p className="text-[10px] text-neutral-400">Register new account into CRM directory</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 text-xs">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-neutral-400 font-semibold mb-1">Total Lifetime Spent ($)</label>
              <input
                type="number"
                min={0}
                value={totalSpent}
            ...
            <div>
              <label className="block text-neutral-400 font-semibold mb-1">Completed Orders</label>
              <input
                type="number"
                min={0}
                value={totalOrders}
