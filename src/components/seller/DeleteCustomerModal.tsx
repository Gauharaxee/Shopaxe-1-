  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-neutral-950/80 backdrop-blur-sm">
      ...
      >
        ...
        <div>
          <h3 className="font-serif text-lg font-bold text-white">Delete Customer Record?</h3>
          <p className="text-xs text-neutral-400 mt-1">
            Are you sure you want to permanently delete profile <strong className="text-white">{customer.name}</strong> ({customer.email})?
          </p>
        </div>
